...
\***************************************************************************************************/
    function runDISPLAYFactory(mode, CID){ //NOTE: {mode = 1} //gallery; {mode = 7} //kryptobook
        try{ 
...
function initSonics(){
    ...
    sonics.track1 = new Audio("./copyrightNetCinematics/SONICS/SYNTHFUZZ_spazeFalcon_4443_warnpeace3.mp3");
